   ...
   initialRoute: '/',
    ...
    getPages: [
     ...
     GetPage(name: '/reportScreen', page: () => const ReportScreen()),
      ...
      GetPage(name: '/SatisfactionReport', page: () => const SatisfactionReport()),
      GetPage(name: '/grievanceReceivedScreen', page: () => const GrievanceReceivedScreen()),
      GetPage(name: '/GrReceivedDetails', page: () => const GrReceivedDetails()),
      GetPage(name: '/GrievanceRecievedResolved', page: () => const GrievanceRecievedResolved()),
